...
Based on Christopher Alexander's "15 Properties of Living Structure" from *The Nature of Order* (2002-2005), interpreted for software systems.
...
The system has clear cores — parts that everything else orbits and supports.
...
Thick, well-defined boundaries protect centers and mediate between inside and outside.
...
- [ ] **Thick boundaries given space** — boundary code (parsers, adapters, API layers) is given adequate space and attention, not treated as afterthought
...
Quiet, empty spaces exist that allow life to bloom within them.
...
The system is deeply adapted to its context — users, tools, environment — and doesn't call attention to itself.
